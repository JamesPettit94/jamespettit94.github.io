   ...
   // Sidemenu toggle
    ...
    wind.on("scroll",function () {
        ...
        if(bodyScroll > 100){
            ...
            logo.attr('src', 'img/jplogohalf.png');
            darkbg.attr('src', 'img/jplogodark.png');
            themebg.attr('src', 'img/jplogodark.png');
            lightbg.attr('src', 'img/jplogohalf.png');

        }else{
            navbar.removeClass("nav-scroll");
            logo.attr('src', 'img/jplogodark.png');
            lightbg.attr('src', 'img/jplogohalf.png');
            themebg.attr('src', 'img/jplogodark.png');
            navbloglogo.attr('src', 'img/jplogohalf.png');
        }
    });
